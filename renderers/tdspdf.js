// Generate Agent TDS Date Range

const agentTDSAPICallDateWise = (id) => {
  return axios
    .post(
      `http://localhost:3000/api/tdspdfdatewise/${id}`,
      {
        from: fromDate,
        to: toDate,
      },
...
function printTdsLedgerPdf(id) {
  agentTDSAPICallDateWise(id).then(async (results) => {
